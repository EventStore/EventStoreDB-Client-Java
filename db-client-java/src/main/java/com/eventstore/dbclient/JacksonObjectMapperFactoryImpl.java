...
public class JacksonObjectMapperFactoryImpl implements JacksonObjectMapperFactory {
  @Override
  ...
  @Override
  public Map<PropertyAccessor, Visibility> overrideConfiguredVisibility(String bindingName, Map<PropertyAccessor, Visibility> visibility) {
    return visibility;
  }
}
